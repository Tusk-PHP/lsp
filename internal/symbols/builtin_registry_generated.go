...
// Generated with PHP 8.5.5 using get_defined_functions(), get_declared_classes(), get_declared_interfaces(), and get_declared_traits().
...
var generatedBuiltinFunctionNames = []string{
	...
	"zstd\\compress_dict",
	"zstd\\compress_init",
	"zstd\\compress_usingcdict",
	"zstd\\decompress",
	"zstd\\decompress_dict",
	"zstd\\decompress_usingcdict",
	"zstd\\uncompress",
	"zstd\\uncompress_add",
	"zstd\\uncompress_dict",
	"zstd\\uncompress_init",
	"zstd\\uncompress_usingcdict",
	"zstd_compress",
	"zstd_compress_add",
	"zstd_compress_dict",
	"zstd_compress_init",
	...
	"zstd_decompress",
	"zstd_decompress_dict",
	"zstd_decompress_usingcdict",
	"zstd_uncompress",
	"zstd_uncompress_add",
	"zstd_uncompress_dict",
	"zstd_uncompress_init",
	"zstd_uncompress_usingcdict",
}
